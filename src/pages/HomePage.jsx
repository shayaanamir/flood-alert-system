      ...
      <div className="container">
        ...
        <header className="homePage-header">
          ...
          <p className="subtitle">
            ...
            and your loved ones safe during emergencies.
          </p>
        </header>
              ...
              <div className="how-it-works-card">
                ...
                <div className="steps-list">
                  ...
                  <div className="step-item">
                    ...
                    <p>We monitor rainfall forecasts and flood risks in your area</p>
                  </div>
                  <div className="step-item">
          ...
          <div className="right-column">
            <section className="alert-signup">
              <div className="form-header">
                ...
                <p>
                  Stay informed with real-time alerts about flood risks in your
                  area. We'll only notify you when it matters.
                </p>
              </div>
        ...
        <section className="features-section">
          <div className="feature-card">
            ...
            <h3>View Risk</h3>
            <p>
              Check real-time flood risk levels based
              on current weather forecasts for your
              location.
            </p>
          </div>
          ...
          <div className="feature-card">
            ...
            <p>
              ...
              evacuation routes in case of flooding.
            </p>
          </div>
          ...
          <div className="feature-card">
            ...
            <p>
              ...
              flood damage to help with assessment
              and recovery.
            </p>
          </div>
        </section>
